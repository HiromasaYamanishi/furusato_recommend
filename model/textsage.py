...
class TextSAGE(torch.nn.Module):
    def __init__(self, config, dataset):
        ...
        for u, i in zip(trainUser, trainItem):
            self.user_oc[u]+=1
            self.item_oc[i]+=1
        # load categorical feature like Customer: (age, location) Product: (price, location)
        ...
        # load word embedding extracted from pretrained word2vec
        ...
        # load item/user category embedding like age, category, price
        ...
        self.factorization_machine = FactorizationMachine(reduce_sum=False)
        # load item sentence feature extracted by sentence-transformer
        ...
        # load numeric feature based on cross purchase counter
        ...
        # Linear Layer to convert numeric feature
        ...
        #'n' means cross numerical embedding
        #'c' means categorical embedding
        #'t' means text embedding
        #'w' means word embedding
        #'s' means sentence embedding
        #'w' means word embedding
        ...
        # 3type of item textual feature, name, main_comment, main_list_comment
